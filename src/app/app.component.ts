...
const recompensas = [
  { nombre: 'Recompensa 1', disponible: true, canjeado: false, imagen: '/assets/cena.png', descripcion: "Es hora de arreglarse y salir a cenar.", temas_para_desbloquear: 15 },
  { nombre: 'Recompensa 2', disponible: true, canjeado: false, imagen: '/assets/merienda.png', descripcion: "Pues que mejor que un merienda para amenizar la tarde.", temas_para_desbloquear: 3 },
  ...
  { nombre: 'Recompensa 6', disponible: false, canjeado: false, imagen: '/assets/motivacion.png', descripcion: "SORPRESA, sientate y disfruta.", temas_para_desbloquear: 23 },
];
